...
public class ContentController : MonoBehaviour
{
    ...
    private UIContainerContentPreview.DataContentDisplay contentDisplayHelper;
    ...
    private void Start()
    {
        contentDisplayHelper = UIContainerContentPreview.instance.GetDataContentDisplay;
